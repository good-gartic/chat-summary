...
export const OPENAI_DEFINITION_PROMPT = `Define the word or sentence. Keep is simple and precise. If there is a complicated word,
          provide a separate dictionary-like definition.`;
